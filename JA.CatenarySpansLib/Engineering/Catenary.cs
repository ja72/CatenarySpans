    ...
    public class Catenary : Span, IEquatable<Catenary>, ICloneable, IFormattable
    {
        ...
        public Vector2 SagPosition
        {
            get
            {
                ...
                return StartPosition+CatenaryCalculator.PositionAtX(center: RelativeCenter, weight, horizontalTension, x);
            }
        }
        /// <summary>
        ...
        public Vector2 StartTension
        {
            get
            {
                return new Vector2(-horizontalTension, -CatenaryCalculator.VertricalTensionAtX(center: RelativeCenter, weight, horizontalTension, 0));
            }
        }
        [ReadOnly(true), XmlIgnore(), Bindable(BindableSupport.No), Browsable(false)]
        public Vector2 EndTension
        {
            get
            {
                return new Vector2(horizontalTension, CatenaryCalculator.VertricalTensionAtX(center: RelativeCenter, weight, horizontalTension, StepX));
            }
        }
        /// <summary>
        ...
        public double MaxTension
        {
            get
            {
                return RelativeCenter.X<=StepX/2?
                    CatenaryCalculator.TotalTensionAtX(center: RelativeCenter, weight, horizontalTension, 0):
                    CatenaryCalculator.TotalTensionAtX(center: RelativeCenter, weight, horizontalTension, StepX);
            }
        }
        [ReadOnly(true), XmlIgnore()]
        [TypeConverter(typeof(NiceTypeConverter))]
        ...
        {
            get { return -CatenaryCalculator.VertricalTensionAtX(center: RelativeCenter, weight, horizontalTension, 0); }
        }
        [ReadOnly(true), XmlIgnore()]
        [TypeConverter(typeof(NiceTypeConverter))]
        public double EndVerticalTension
        {
            get { return CatenaryCalculator.VertricalTensionAtX(center: RelativeCenter, weight, horizontalTension, StepX); }
        }
        [ReadOnly(true), XmlIgnore()]
        [TypeConverter(typeof(NiceTypeConverter))]
        public double StartTotalTension
        {
            get { return CatenaryCalculator.TotalTensionAtX(center: RelativeCenter, weight, horizontalTension, 0); }
        }
        [ReadOnly(true), XmlIgnore()]
        [TypeConverter(typeof(NiceTypeConverter))]
        public double EndTotalTension
        {
            get { return CatenaryCalculator.TotalTensionAtX(center: RelativeCenter, weight, horizontalTension, StepX); }
        }
        ...
        public bool IsCenterInSpan
        {
            get
            {
                double L=CatenaryCalculator.LengthSegmentAtX(center: RelativeCenter, weight, horizontalTension, RelativeCenter.X);
        ...
        public Func<double, Vector2> ParametricTension
        {
            get
            {
                return (t) => new Vector2(horizontalTension, CatenaryCalculator.VertricalTensionAtX(center: RelativeCenter, weight, horizontalTension, CatenaryCalculator.ParameterToX(Step, RelativeCenter, weight, horizontalTension, t)));
            }
        }
        [XmlIgnore(), Browsable(false), Bindable(BindableSupport.No)]
        public Func<double, double> CatenaryFunction
        {
            get
            {
                return (x) => StartPosition.Y+CatenaryCalculator.PositionAtX(center: RelativeCenter, weight, horizontalTension, x-StartPosition.X).Y;
            }
        }
