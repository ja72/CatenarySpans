...
namespace JA.Engineering
{
    public static class CatenaryCalculator
    {
        ...
        {
            return LengthSegmentAtX(center: center, w, H, span.X);
        }
        /// <summary>
        /// Calculate the total length of the curve.
        /// <remarks>The lowest point on the catenary is calculated first.</remarks>
        ...
        public static Vector2 PositionAtX(Vector2 center, double w, double H, double x)
        {
            double a=H/w;
        ...
        public static Vector2 PositionAtT(Vector2 span, Vector2 center, double w, double H, double t)
        {
            ...
            return PositionAtX(center: center, w, H, x);
        }
        /// <summary>
        /// Calculate the position on the curve based on parameter <c>t</c> ranging from 0 to 1.
        /// </summary>
        ...
        /// <param name="t">The parameter from 0..1</param>
        /// <returns>The position vector in (x,y) coordinates</returns>
        public static Vector2 PositionAtT(Vector2 span, double w, double H, double t)
        {
            return PositionAtT(span, CenterPosition(span, w, H), w, H, t);
        }
        /// <summary>
        ...
        /// <param name="x">The x-coordinate</param>
        /// <returns>The length value</returns>
        public static double LengthSegmentAtX(Vector2 center, double w, double H, double x)
        {
            double a=H/w;
        ...
        public static double VertricalTensionAtX(Vector2 center, double w, double H, double x)
        {
        ...
        public static double TotalTensionAtX(Vector2 center, double w, double H, double x)
        {
